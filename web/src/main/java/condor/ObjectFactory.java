 ...
 * generated in the condor package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: condor
     * 
     */
    ...
    public JAXBElement<String> createCreateJobTemplateRequirements(String value) {
        return new JAXBElement<String>(_CreateJobTemplateRequirements_QNAME, String.class, CreateJobTemplate.class, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ClassAdStructArray }{@code >}}
     * 
     */
    ...
    public JAXBElement<ClassAdStructArray> createClassAdStructArrayAndStatusClassAdArray(ClassAdStructArray value) {
        return new JAXBElement<ClassAdStructArray>(_ClassAdStructArrayAndStatusClassAdArray_QNAME, ClassAdStructArray.class, ClassAdStructArrayAndStatus.class, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FileInfoArray }{@code >}}
     * 
     */
    ...
    public JAXBElement<FileInfoArray> createFileInfoArrayAndStatusInfo(FileInfoArray value) {
        return new JAXBElement<FileInfoArray>(_FileInfoArrayAndStatusInfo_QNAME, FileInfoArray.class, FileInfoArrayAndStatus.class, value);
    }
    ...
    public JAXBElement<byte[]> createBase64DataAndStatusData(byte[] value) {
        return new JAXBElement<byte[]>(_Base64DataAndStatusData_QNAME, byte[].class, Base64DataAndStatus.class, ((byte[]) value));
    }
    ...
    public JAXBElement<String> createStringAndStatusMessage(String value) {
        return new JAXBElement<String>(_StatusMessage_QNAME, String.class, StringAndStatus.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ClassAdStruct }{@code >}}
     * 
     */
    ...
    public JAXBElement<Requirements> createRequirementsAndStatusRequirements(Requirements value) {
        return new JAXBElement<Requirements>(_CreateJobTemplateRequirements_QNAME, Requirements.class, RequirementsAndStatus.class, value);
    }
    ...
    public JAXBElement<ClassAdStruct> createClassAdStructAndStatusClassAd(ClassAdStruct value) {
        return new JAXBElement<ClassAdStruct>(_ClassAdStructAndStatusClassAd_QNAME, ClassAdStruct.class, ClassAdStructAndStatus.class, value);
    }
    ...
    public JAXBElement<ClassAdStruct> createDiscoverJobRequirementsJobAd(ClassAdStruct value) {
        return new JAXBElement<ClassAdStruct>(_SubmitJobAd_QNAME, ClassAdStruct.class, DiscoverJobRequirements.class, value);
    }
